...
-- illuminate
--keymap.set("n", "öj", "<CMD>lua require('illuminate').goto_next_reference(warp)<CR>")
--keymap.set("n", "ök", "<CMD>lua require('illuminate').goto_prev_reference(warp)<CR>")
--keymap.set("n", "ös", "<CMD>lua require('illuminate').textobj_select(warp)<CR>")
